        ...
        <section ref={containerRef} className="relative overflow-hidden pt-16 md:pt-20 lg:pt-32 pb-20">
            ...
            <div className="container px-4 md:px-6 relative z-10 mx-auto">
                <div className="flex flex-col items-center text-center gap-8 max-w-4xl mx-auto">
                    ...
                    >
                        <Link href="/about">
                            <Badge variant="outline" className="rounded-full px-4 py-1.5 text-sm border-primary/20 bg-primary/5 hover:bg-primary/10 transition-colors cursor-pointer backdrop-blur-sm">
                    ...
                    >
                        <Link href="/register">
                            <Button size="lg" className="h-12 px-8 text-base gap-2 shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all rounded-full w-full sm:w-auto">
                                Start Free Trial <ArrowRight className="h-4 w-4" />
                            </Button>
                        </Link>
                        <Link href="/pricing">
                            <Button variant="outline" size="lg" className="h-12 px-8 text-base rounded-full w-full sm:w-auto backdrop-blur-sm bg-background/50">
                                View Pricing
                            </Button>
                        </Link>
                    </motion.div>
                ...
                {/* Dashboard Preview dengan scroll fade-in */}
                <motion.div
                    style={{ y, opacity, scale }}
                    className="mt-16 relative mx-auto max-w-5xl perspective-1000"
                >
                    <div className="relative rounded-xl border bg-background/50 backdrop-blur-xl shadow-2xl overflow-hidden transform rotate-x-12 transition-transform hover:rotate-x-0 duration-700 ease-out group">
                    ...
                    >
                        <div className="bg-background/80 backdrop-blur-md border rounded-lg p-4 shadow-xl max-w-[200px]">
