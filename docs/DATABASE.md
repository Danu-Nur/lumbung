****# Database Documentation - Lumbung
...
**Used By Routes**
- `/[locale]/inventory`
- `/[locale]/sales-orders` (Lookup item)
- `/[locale]/purchase-orders` (Lookup item)
...
**Used By Routes**
- `/[locale]/inventory`
- `/[locale]/inventory/transfer`
- `/[locale]/inventory/opname`
...
- `/[locale]/inventory/suppliers` (View Supplier list linked here)
...
- `lib/guards/subscription.ts` (Logic restriction)
