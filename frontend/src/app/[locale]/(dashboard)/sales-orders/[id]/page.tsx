...
import { fulfillSalesOrder, confirmSalesOrder, cancelSalesOrder } from '@/features/sales-orders/actions';
...
export default async function SalesOrderDetailPage({
    ...
    if (!order || !order.customer || !order.warehouse) {
        notFound();
    }
        ...
        <div className="space-y-6 max-w-4xl">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex space-x-2">
                    ...
                    {order.status === 'DRAFT' && (
                        <form action={confirmSalesOrder.bind(null, order.id)}>
                            <Button type="submit">
