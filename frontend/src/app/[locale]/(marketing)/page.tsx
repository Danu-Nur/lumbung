    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1">
                ...
                >
                    ...
                    <ScrollAnimation>
                        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center mb-12">
                            ...
                            <div className="inline-flex items-center rounded-none border-2 border-black px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none text-muted-foreground bg-muted/50">
                                ✨ Features
                            </div>
                    ...
                    <ScrollAnimation animation="fade-up" delay={0.1}>
                        <div className="mt-12 mx-auto max-w-5xl rounded-none border-2 border-black bg-background/60 backdrop-blur-sm shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] p-8">
                ...
                <section
                    id="testimonials"
                    className="container py-12 md:py-24 lg:py-32 bg-slate-50 dark:bg-slate-900/20 rounded-none border-2 border-black mx-auto"
                >
                    <ScrollAnimation>
                            ...
                            >
                                <Card
                                    className={`flex flex-col h-full ${(plan as any).popular
                                        ? "border-black border-2 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative scale-105 z-10"
                                        : ""
                                        }`}
                                >
                                    <div className="absolute top-0 right-0 -mt-2 -mr-2">
                                        <Badge className="bg-primary text-primary-foreground rounded-none border border-black">
                        ...
                        <div className="container flex flex-col items-center text-center gap-6 relative z-10">
                            ...
                            <Link href="/register">
                                <Button
                                    size="lg"
                                    variant="secondary"
                                    className="gap-2 h-12 px-8 rounded-none border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all"
                                >
                                    {t("cta.button")}{" "}
