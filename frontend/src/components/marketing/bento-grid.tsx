...
const features = [
    {
        ...
        header: (
            <div className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-none border-b-2 border-black bg-gray-50 dark:bg-neutral-900">
                <GridPattern />
                <div className="relative z-10 grid grid-cols-1 gap-2 opacity-60 mix-blend-multiply dark:mix-blend-normal">
                    <div className="h-2 w-24 rounded-none border border-black bg-neutral-300 dark:bg-neutral-700"></div>
                    <div className="h-2 w-32 rounded-none border border-black bg-blue-400"></div>
                    <div className="h-2 w-20 rounded-none border border-black bg-neutral-300 dark:bg-neutral-700"></div>
                </div>
    ...
    },
    {
        ...
        header: (
            <div className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-none border-b-2 border-black bg-gray-50 dark:bg-neutral-900">
                ...
                <div className="absolute h-24 w-24 rounded-none bg-blue-500/20 blur-xl"></div>
            </div>
        ),
    ...
    },
    {
        ...
        header: (
            <div className="relative flex h-full w-full items-end justify-center space-x-2 overflow-hidden rounded-none border-b-2 border-black bg-gray-50 pb-4 dark:bg-neutral-900">
                <GridPattern />
                <div className="h-8 w-4 rounded-none border border-black bg-neutral-300 dark:bg-neutral-700"></div>
                <div className="h-14 w-4 rounded-none border border-black bg-green-500/60"></div>
                <div className="h-10 w-4 rounded-none border border-black bg-neutral-300 dark:bg-neutral-700"></div>
                <div className="h-16 w-4 rounded-none border border-black bg-green-500"></div>
            </div>
        ),
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 md:grid-cols-3">
            {features.map((feature, i) => (
                <ScrollAnimation
                    ...
                    delay={i * 0.1}
                    className={cn(
                        "group/bento row-span-1 flex flex-col justify-between overflow-hidden rounded-none border-2 border-black bg-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition duration-300 hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] dark:border-white/10 dark:bg-neutral-950",
                        feature.className
                    )}
                >
